...
public class StalkersAdapter extends BaseAdapter {
    Context ctx;
    LayoutInflater lInflater;
    ArrayList<Stalkers> objects;

    protected ListView mListView;
    public StalkersAdapter(Context context, ArrayList<Stalkers> stalkers, Activity activity) {
        super();
        ctx = context;
        objects = stalkers;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Stalkers p = getStalkers(position);
    ...
    Stalkers getStalkers(int position) {
        return ((Stalkers) getItem(position));
    }
